...
import com.indien.indien_backend.config.ApplicationConfig;
...
public class TokenProvider
{
    ...
    public TokenProvider(ApplicationConfig applicationConfig){
        String secret = applicationConfig.getSecret();
